# Function to return the given string duplicate the given number of times
...
# Function to return a string "splosion" a new string made up of a combination of each substring of the given string
